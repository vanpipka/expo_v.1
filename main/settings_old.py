...
with open(os.path.join(SETTINGS_DIR, 'companysettings.json'), 'r') as f:
    ...
    print('Читаем настройки компании')
    ...
    try:
        ...
        COMPANY_ADDRESS = 'Не указан'  # "117452 г.Москва, ул.Азовская, 24/3"
        COMPANY_PHONE   = 'Не указан'  # "8 8 (800) 555-55-55"
        COMPANY_EMAIL   = 'Не указан'  # "info@vseexpo.ru"
