...
class JobOrder(models.Model):
    ...
    def GetActual(self, user=None):
        ...
        objects = list(JobOrder.objects.all().filter(deleted=False).select_related('city').select_related('company').order_by("-created").values('id', 'responseCount', 'description', 'date', 'enddate', 'place', 'created', 'company', 'city', 'city_id', 'city__name', 'company__name', 'company__image'))
